...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="container">
	<tr>
		<td width="670" height="600" valign="top">
			...
			<!-- weibo 开始-->
			<c:forEach items="${lstComment}" var="lstsearch1">
			<table id="weibo" width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
				<tr>
					<td rowspan="3" align="center" valign="top"><img src="${lstsearch1.u_images}" width="50" height="50" /></td>
					<td width="88%" class="content">${lstsearch1.u_name}<img src="icon/v.gif" width="11" height="10" align="middle" />：${lstsearch1.c_content}</td>
				</tr>
			...
			<table>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td><a href="home.jsp?No=1">返回</a></td>
				</tr>
			</table>
			<!-- weibo 结束-->
		</td>
